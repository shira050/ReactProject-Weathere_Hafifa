...
export default function SoliderCard(props) {
  ...
  return (
    <div className={`profileCard Rectangle ${isSelected ? 'selected-card ' : ''}`} onClick={handleSelect}>
      <div className='cardProfile'>
        <img
          className='imgProfile Oval'
          src={
      ...
      <div className='col'>
      <p className='-style-1'>{currentSolider.Last_Name} {currentSolider.First_Name}</p>
        <p className='G'>{currentSolider.Rank}, {currentSolider.Age} </p>
        <p className='-\2'>{currentSolider.Rank}, {currentSolider.Role} </p>
      </div>
